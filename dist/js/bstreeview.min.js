...
b.collapse("show");e&&a(".state-icon",this).toggleClass(d.settings.expandIcon).toggleClass(d.settings.collapseIcon);return this},bstreeItemDisable:function(a){a?this.addClass("disabled"):this.removeClass("disabled");return this}});c.append(e);b.nodes&&(e=a('<div class="list-group collapse" id="itemid"></div>').attr("id",d.itemIdPrefix+b.nodeId),c.append(e),d.build(e,b.nodes,h))})}});a.fn.bstreeview=function(c){return this.each(function(){a.data(this,"plugin_bstreeview")||a.data(this,"plugin_bstreeview",
